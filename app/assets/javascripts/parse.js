...
var application_id = "qtPnuzn38Stuo5olj3BQ7R2QcLGQNADRoNL89F1U";
var rest_api_key = "6vlXGW2j2bRMYOLxYFLe6FdnGprmPGao2mOkq7Zh";
var api_version = "1";
...
(function() {
  ...
  Backbone.sync = function(method, model, options) {
    ...
    var order;
    if (options.order && method == "read") {
        data = data + encodeURI("&order="+ options.order);
    }   

    var limit;
    if (options.limit && method == "read") {
        data = data + encodeURI("&limit="+ JSON.stringify(options.limit));
    } 
